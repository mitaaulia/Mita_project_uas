 <body>
  ...
  <head>
        ...
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="<?php echo base_url()?>detail/assets/favicon.ico" />
        <!-- Bootstrap icons-->
        <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css" rel="stylesheet" />
        <!-- Core theme CSS (includes Bootstrap)-->
        <link href="<?php echo base_url()?>detail/css/styles.css" rel="stylesheet" />
    </head>
 ...
 <?php foreach ($produk as $p) : ?>
            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <p class="lead">Tersedia ukuran mulai dari 36-39 cm. Dapatkan harga promo dan potongan ongkir pada setiap pembelian itemnya</p>
                        <div class="d-flex">
                            <input class="form-control text-center me-3" name="jumlah" value="0" type="number" style="max-width: 4rem" />
                            <a href="https://wa.me/qr/2YIFWUUTUFJCC1"><button class="btn btn-outline-dark flex-shrink-0" type="button">
                                Beli
                            </button></a>
                        </div>
                    </div>
        ...
        <script src="<?php echo base_url()?>assets1/js/scripts.js"></script>
         ...
         <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js"></script>
        <!-- Core theme JS-->
        <script src="<?php echo base_url()?>detail/js/scripts.js"></script>
    </body>
</html>
